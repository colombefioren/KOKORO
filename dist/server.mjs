...
app.prepare().then(() => {
    ...
    io.on("connection", (socket) => {
        ...
        socket.on("update-video-state", (videoState) => {
            ...
            const hostId = roomHosts.get(roomId);
            roomStates.set(roomId, Object.assign(Object.assign({}, videoState), { lastUpdatedAt: new Date() }));
        ...
        socket.on("change-video", (data) => {
            ...
            const newState = {
                ...
                paused: true,
                currentTime: 0,
                volume: (_a = prevState === null || prevState === void 0 ? void 0 : prevState.volume) !== null && _a !== void 0 ? _a : 100,
                roomId,
                lastUpdatedBy,
                lastUpdatedAt: new Date(),
            };
            roomStates.set(roomId, newState);
            socket.to(`room:${roomId}`).emit("video-changed", Object.assign(Object.assign({}, newState), { previousVideoId }));
        });
